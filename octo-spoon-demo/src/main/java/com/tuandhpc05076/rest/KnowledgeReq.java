...
public class KnowledgeReq {
    ...
    public String relevantSentence() throws Exception {
        String inputText = "France (French: Listen), officially the French Republic (French: République française ),[14] is a country located primarily in Western Europe." +
                                   " It also includes overseas regions and territories in the Americas and the Atlantic, Pacific and Indian Oceans,[XII] giving it one of the largest discontiguous exclusive economic zones in the world. " +
       ...
       //return textAnalyzer.extractRelevantSentences(inputText, "French territories", 4);
        List<String> relevantSentences = textAnalyzer.extractRelevantSentences(inputText, "French territory", 4);
        return  String.join("\n", relevantSentences);
    }
